...
def init_args():
    ...
    parser.add_argument("--image_dir", type=str, default='./doc/test_sheets/'+base_path+"")
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str, default='./inference/ch_det_infer/')
    parser.add_argument("--det_limit_side_len", type=float, default=960)
    parser.add_argument("--det_limit_type", type=str, default='max')

    # DB parmas
    parser.add_argument("--det_db_thresh", type=float, default=0.3)
    parser.add_argument("--det_db_box_thresh", type=float, default=0.4)
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./inference/ch_rec_infer/')
    parser.add_argument("--rec_image_shape", type=str, default="3, 32, 320")
    parser.add_argument("--rec_char_type", type=str, default='ch')
    parser.add_argument("--rec_batch_num", type=int, default=6)
    parser.add_argument("--max_text_length", type=int, default=25)
    parser.add_argument("--rec_char_dict_path", type=str, default="./ppocr/utils/ocr_keys.txt")
    ...
    parser.add_argument("--cls_model_dir", type=str, default='./inference/ch_cls_infer/')
    ...
    # 化验单栏数判断阈值
    parser.add_argument("--sub_table_thresh", type=float, default=0.5)
    # 化验单表头文本框分词阈值
    parser.add_argument("--head_word_seg_thresh", type=float, default=0.75)
    # 行切割阈值
    parser.add_argument("--horizon_line_split_thresh", type=float, default=0.6)
...
def draw_ocr(image, boxes, txts=None, scores=None, drop_score=0.5, font_path="./doc/fonts/simfang.ttf"):
    ...
    if txts is not None:
        ...
        txt_img = text_visual(txts, scores, img_h=img.shape[0], img_w=600, 
            threshold=drop_score, font_path=font_path)
...
def text_visual(texts, scores, img_h=400, img_w=600, threshold=0., font_path="./doc/fonts/simfang.ttf"):
    """
